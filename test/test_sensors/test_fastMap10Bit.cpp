...
static void test_fastMap10Bit_negative_range(void) {
    ...
    // Greater than 10-bit input should be clamped to the ADC range.
    TEST_ASSERT_EQUAL_INT(-501, fastMap10Bit(1023*2, -1500, -500));
}
...
static void test_fastMap10Bit_positive_range(void) {
    ...
    // Greater than 10-bit input should be clamped to the ADC range.
    TEST_ASSERT_EQUAL_INT(1499, fastMap10Bit(1023*2, 500, 1500));
}
